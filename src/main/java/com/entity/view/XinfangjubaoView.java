...
public class XinfangjubaoView extends XinfangjubaoEntity implements Serializable {
    private static final long serialVersionUID = 1L;

		/**
		* 信访举报类型的值
		*/
		private String xinfangjubaoValue;
	...
	public XinfangjubaoView() {

	}

	public XinfangjubaoView(XinfangjubaoEntity xinfangjubaoEntity) {
		try {
			BeanUtils.copyProperties(this, xinfangjubaoEntity);
			...
			* 获取： 信访举报类型的值
			*/
			public String getXinfangjubaoValue() {
				return xinfangjubaoValue;
			}
			/**
			* 设置： 信访举报类型的值
			*/
			public void setXinfangjubaoValue(String xinfangjubaoValue) {
				this.xinfangjubaoValue = xinfangjubaoValue;
			}
