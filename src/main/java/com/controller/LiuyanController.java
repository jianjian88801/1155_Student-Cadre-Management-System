    ...
    public R info(@PathVariable("id") Long id, HttpServletRequest request){
        ...
        if(liuyan !=null){
            ...
            BeanUtils.copyProperties( liuyan , view );//把实体数据重构到view中
                ...
                //级联表
                XueshengganbuEntity xueshengganbu = xueshengganbuService.selectById(liuyan.getXueshengganbuId());
    ...
    */
    ...
    public R save(@RequestBody LiuyanEntity liuyan, HttpServletRequest request){
        ...
        if(StringUtil.isEmpty(role))
            ...
            liuyan.setXueshengganbuId(Integer.valueOf(String.valueOf(request.getSession().getAttribute("userId"))));
...
//                            liuyanEntity.setXueshengganbuId(Integer.valueOf(data.get(0)));   //学生干部 要改的
